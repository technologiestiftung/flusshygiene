...
FROM technologiestiftung/flusshygiene-opencpu-base:v0.5.1-dev as base
...
# COPY "./files/.vimrc" "~/"
RUN R -e "remotes::install_github(\"kwb-r/fhpredict@v0.8.0\", build_vignettes = FALSE, force= TRUE)"
