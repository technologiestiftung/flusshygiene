...
echo
echo "    ${RED}npm run lerna:version -- ${GREEN}${VERSION}${RED} && git add . && git ci -m \"v${GREEN}${VERSION}${RED}\" && npm version ${GREEN}${VERSION}${RED} --no-git-tag-version && git add . && git ci -m \"v${GREEN}${VERSION}${RED}\"${NC}"
echo
