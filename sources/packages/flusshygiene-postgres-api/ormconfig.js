...
console.log(`NODE_ENV: ${NODE_ENV} API Version: ${version}`);
...
if (NODE_ENV !== 'development' && NODE_ENV !== 'production') {
  process.stderr.write(
    `NODE_ENV is neither "DEV" nor "PROD" aborting spinup\n`,
  );
  process.exit(1);
}
...
if (process.env.NODE_DOCKER_ENV === '1') {
  ...
  process.stderr.write(
    '"process.env.NODE_DOCKER_ENV" is not defined What is your env? Aborting spinup\n',
  );
  process.exit(1);
}
