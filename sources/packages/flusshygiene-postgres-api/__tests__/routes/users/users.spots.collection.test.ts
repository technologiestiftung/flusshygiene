...
describe('GET all collection tyoe', () => {
  ...
  test(' should fail due to wrong user id route GET user by id spot by id predictions', async (done) => {
    const res = await request(app).get('/api/v1/users/5/bathingspots/1/predictions').set(headers);
  ...
  test(' should fail due to wrong spot id route GET user by id spot by id predictions', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1000/predictions').set(headers);
    expect(res.status).toBe(404);
    expect(Array.isArray(res.body.success)).toBe(false);
    done();
  });
  ...
  test('route GET user by id spot by id predictions', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/predictions').set(headers);
  ...
  test('route GET user by id spot by id measurements', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/measurements').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  test('route GET user by id spot by id discharges', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/discharges').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  test('route GET user by id spot by id rains', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/rains').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  test('route GET user by id spot by id globalIrradiances', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/globalIrradiances').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  test('route GET user by id spot by id models', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/models').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  test('route GET user by id spot by id purificationPlants', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/purificationPlants').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  test('route GET user by id spot by id genericInputs', async (done) => {
    const res = await request(app).get('/api/v1/users/1/bathingspots/1/genericInputs').set(headers);
    expect(res.status).toBe(200);
    expect(Array.isArray(res.body.data)).toBe(true);
    done();
  });
  ...
  test('route POST user by id spot by id predictions', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/predictions').send({
      "percentile2_5": null,
      "percentile50": null,
      "percentile90": null,
      "percentile95": null,
  ...
  test('route POST user by id spot by id measurements', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/measurements').send({
      "sicht": 1000000,
  ...
  test('route POST user by id spot by id discharges', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/discharges').send({
      "value": 1000,
      "dateTime": "05:23:42",
      "date": "08-Jan-1999",
  ...
  test('route POST user by id spot by id rains', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/rains').send({
      "value": 1000,
      "dateTime": "05:23:42",
      "date": "08-Jan-1999",
      "comment": "This is a comment, can be NULL"
  ...
  test('route POST user by id spot by id globalIrradiances', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/globalIrradiances').send({
      "value": 1000,
      "dateTime": "05:23:42",
      "date": "08-Jan-1999",
      "comment": "This is a comment, can be NULL"
  ...
  test('route POST user by id spot by id models', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/models').send({
  ...
  test('route POST user by id spot by id purificationPlants', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/purificationPlants').send({
  ...
  test('route POST user by id spot by id genericInputs', async (done) => {
    const res = await request(app).post('/api/v1/users/1/bathingspots/1/genericInputs').send({
      "name": "OberunterAmergau"
    }).set(headers);
    expect(res.status).toBe(201);
    expect(Array.isArray(res.body.data)).toBe(true);
